...
module.exports = function (server) {
  ...
  const functionality = function (server) {
    return {
      /**
        * Registers CRUD REST services for the config provided.
        * config content:
        *  basePath: The REST endpoint's base path for all CRUD operations.
        * This will be the REST endpoint for the "find all" operation other operations may add an identifier: basePath + '/{id}'.
        * Must not start nor end with '/'.
        * bookshelfModel: Reference to the bookshelf model (e.g. created with bookshelf.Model.extend({})) representing the entity 
        * the basePath's CRUD operations are invoked on.
        */
